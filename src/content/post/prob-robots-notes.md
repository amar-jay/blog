...
The dual of Kalman filter is the information filter. Similar to KF and EKF, the belief is a _guassian-ish_.

#### Difference between K.F and I.F

Whereas in the Kalman filter family of algorithms, Gaussians are represented by _their moments (mean, covariance)_, **information filters represent Gaussians in their canonical representation**, which is comprised of an **information matrix** and **an information vector**.
...
The matrix $\Omega$ determines the rate at which the l function increases in the different dimensions of the variable $x$. A quadratic distance that is weighted by a matrix $\Omega$ is called **_Mahalanobis distance._**
